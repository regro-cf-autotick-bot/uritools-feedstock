...
Development: https://github.com/tkem/uritools/

Documentation: http://pythonhosted.org/uritools/
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/uritools-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/uritools-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `uritools` can be installed with `conda`:
...
```
mamba install uritools
```

It is possible to list all of the versions of `uritools` available on your platform with `conda`:
...
```
mamba search uritools --channel conda-forge
```
...
mamba repoquery search uritools --channel conda-forge

# List packages depending on `uritools`:
mamba repoquery whoneeds uritools --channel conda-forge

# List dependencies of `uritools`:
mamba repoquery depends uritools --channel conda-forge
```
